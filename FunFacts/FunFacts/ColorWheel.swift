...
struct ColorWheel {
    var colorsArray = [
        ...
        UIColor(red: 223/255.0, green: 86/255.0, blue: 90/255/0, alpha: 1.0),
        UIColor(red: 239/255.0, green: 130/255.0, blue: 82/255/0, alpha: 1.0),
        UIColor(red: 77/255.0, green: 75/255.0, blue: 100/255/0, alpha: 1.0),
    ...
    func randomColor() -> UIColor {
        ...
        return colorsArray[randonNumber]
    }
}
